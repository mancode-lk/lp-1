			...
			<div class="page-wrapper">
				<div class="content">
					...
					<?php
						...
						if(isset($_REQUEST['from_date'])){
							$sql_orders = "SELECT * FROM tbl_orders WHERE or_date BETWEEN '$from_date' AND '$to_date'";
						}
						else {
					...
					<div class="row">
						...
						<div class="col-lg-3 col-sm-6 col-12 d-flex">
							<div class="dash-count das3">
								<div class="dash-counts" style="cursor:pointer;" onclick="showOrderOfUsers(1)">
									<h4><?= $confirmed ?></h4>
						...
						<div class="col-lg-3 col-sm-6 col-12 d-flex">
							<div class="dash-count das2">
								<div class="dash-counts" style="cursor:pointer;" onclick="showOrderOfUsers(3)">
									<h4><?= $no_answer ?></h4>
									<h5>No Answer</h5>
								</div>
								<div class="dash-imgs">
						...
						<div class="col-lg-3 col-sm-6 col-12 d-flex">
							<div class="dash-count">
								<div class="dash-counts" style="cursor:pointer;" onclick="showOrderOfUsers(6)">
									<h4><?= $wrong_number ?></h4>
									<h5>Wrong Number</h5>
								</div>
								<div class="dash-imgs">
						...
						<div class="col-lg-3 col-sm-6 col-12 d-flex">
							<div class="dash-count" style="background-color:#6e126b;">
								<div class="dash-counts" style="cursor:pointer;" onclick="showOrderOfUsers(4)">
									<h4><?= $phone_off ?></h4>
									<h5>Phone Off</h5>
								</div>
								<div class="dash-imgs">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-sm-6 col-12 d-flex">
							<div class="dash-count das3" style="background-color:#305e34;">
								<div class="dash-counts" style="cursor:pointer;" onclick="showOrderOfUsers(12)">
									<h4><?= $delivered ?></h4>
						...
						<div class="col-lg-3 col-sm-6 col-12 d-flex">
							<div class="dash-count das2" style="background-color:#22083d;">
								<div class="dash-counts" style="cursor:pointer;" onclick="showOrderOfUsers(8)">
									<h4><?= $re_arranged ?></h4>
									<h5>Re Arranged</h5>
								</div>
								<div class="dash-imgs">
						...
						<div class="col-lg-3 col-sm-6 col-12 d-flex">
							<div class="dash-count" style="background-color:#08263d;">
								<div class="dash-counts" style="cursor:pointer;" onclick="showOrderOfUsers(9)">
									<h4><?= $re_schu ?></h4>
									<h5>RESCHEDULED</h5>
								</div>
								<div class="dash-imgs">
						...
						<div class="col-lg-3 col-sm-6 col-12 d-flex">
							<div class="dash-count das1" style="background-color:#360600;">
								<div class="dash-counts" style="cursor:pointer;" onclick="showOrderOfUsers(7)">
									<h4><?= $canceled ?></h4>
									<h5>Canceled</h5>
								</div>
								<div class="dash-imgs">
						...
						<div class="col-lg-3 col-sm-6 col-12 d-flex">
							<div class="dash-count" style="background-color:#422833;">
								<div class="dash-counts" style="cursor:pointer;" onclick="showOrderOfUsers(10)">
									<h4><?= $fail_to_del ?></h4>
						...
						<div class="col-lg-3 col-sm-6 col-12 d-flex">
							<div class="dash-count das2" style="background-color:#8a2c54;">
								<div class="dash-counts" style="cursor:pointer;" onclick="showOrderOfUsers(11)">
									<h4><?= $return ?></h4>
									<h5>RETURNED</h5>
								</div>
								<div class="dash-imgs">
		...
		<script type="text/javascript">
			function showOrderOfUsers(or_st){
				$('#order_status_by_users').modal('show');
				$('#show_status_users').load('ajax_pages/order_st_by_users.php',{
					order_status:or_st
                    <?php
                        if(isset($_REQUEST['from_date'])){ ?>
                            ,from_date:"<?= $from_date ?>",
